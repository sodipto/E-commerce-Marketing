...
<div style="padding-left:300px;"  class="col-md-8">
    <div class="form-group">
      ...
      <asp:TextBox ID="Point" class="form-control" validationgroup="addproductbutton"  placeholder="Enter Product Point" runat="server"></asp:TextBox>
         <asp:RequiredFieldValidator ID="RequiredFieldValidator6" validationgroup="addproductbutton" runat="server" ErrorMessage="Product Point Require" ControlToValidate="Point" ForeColor="Red"></asp:RequiredFieldValidator>
    </div>
</div>
</div>
